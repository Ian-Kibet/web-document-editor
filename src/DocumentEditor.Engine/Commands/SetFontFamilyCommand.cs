...
public class SetFontFamilyCommand : ICommand
{
    private readonly string? _fontFamily;

    public SetFontFamilyCommand(string? fontFamily)
    {
    ...
    public EditorState Execute(EditorState state)
    {
        ...
        if (sel.IsCollapsed)
        {
            ...
            run.Properties.FontFamily = _fontFamily;
        ...
        foreach (var r in runs)
            r.Properties.FontFamily = _fontFamily;
